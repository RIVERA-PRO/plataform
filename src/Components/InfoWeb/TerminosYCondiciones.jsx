    ...
    return (
        <div className="InfoContain">
            ...
            <div className="sectionInfo">
                ...
                <p>Al usar esta APLICACIÓN WEB <strong> Putas México - Mamis Vip México</strong> aceptas los siguientes <strong>{info?.replace(/-/g, ' ')}</strong>, por lo que te pedimos leerla.</p>
            ...
            <div className="sectionInfo">
                ...
                <p><strong> Putas México - Mamis Vip México</strong> con razón social de nacionalidad mexicana Servicios de Internet S.A. de C.V., con domicilio en <strong>{contacto?.direccion}</strong> y correo electrónico <strong>{contacto?.email}</strong> se declara propietaria de:</p>
                <ul>
            ...
            <div className="sectionInfo">
                ...
                <p>La APLICACIÓN WEB <strong> Putas México - Mamis Vip México</strong> es titularidad de la empresa citada en el punto uno de este documento, en adelante el <strong>PROVEEDOR DE SERVICIOS</strong>.</p>
