...
$mensaje = "";
$carpetaImagenes = './imagenes_publicaciones'; // Cambia la ruta de la carpeta
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!$idPublicacion) {
            echo json_encode(["error" => "Se requiere proporcionar un ID de publicacion para actualizar las imágenes."]);
            exit;
        }
